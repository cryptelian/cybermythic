...
export class AnarchyDice {
  ...
  static init() {
    ...
    Hooks.once("diceSoNiceReady", (dice3d) =>
      AnarchyDice.diceSoNiceReady(dice3d),
    );
    ...
    return {
      ...
      [REROLL_REMOVED_COLORSET]: {
        ...
        description: game.i18n.localize(
          ANARCHY.common.roll.rollTheme.rerollRemoved,
        ),
        category: SYSTEM_DESCRIPTION,
      },
      [GLITCH_COLORSET]: {
      ...
      [RISK_COLORSET]: {
        name: RISK_COLORSET,
        description: game.i18n.localize(
          ANARCHY.common.roll.rollTheme.anarchyRisk,
        ),
        category: SYSTEM_DESCRIPTION,
        foreground: "#faecd1",
        background: "#040101",
  ...
  static diceSoNiceReady(dice3d) {
     ...
     */
    Object.values(AnarchyDice.COLORSETS).forEach((colorset) =>
