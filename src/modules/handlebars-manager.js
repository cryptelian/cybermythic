...
export class HandlebarsManager {
  ...
  registerBasicHelpers() {
    Handlebars.registerHelper("concat", (...args) =>
      Misc.join(args.slice(0, -1)),
    );
    Handlebars.registerHelper("substring", (str, from, to) =>
    ...
    Handlebars.registerHelper(
      "isInteger",
      (a) => a !== undefined && Number.isInteger(a),
    );
    Handlebars.registerHelper(
      "actorAttribute",
      (attribute, actor, item = undefined) => {
    ...
    Handlebars.registerHelper(
      "padWordListToMin",
      AnarchyBaseActor.padWordListToMin,
    );
    Handlebars.registerHelper("sortSkills", AnarchyBaseActor.sortSkills);
    Handlebars.registerHelper(
      "sortShadowamps",
      AnarchyBaseActor.sortShadowamps,
    );
    Handlebars.registerHelper("actorTabClosed", actorTabClosed);
    Handlebars.registerHelper("ifTabClosed", ifTabClosed);
    Handlebars.registerHelper("sortQualities", AnarchyBaseActor.sortQualities);
    Handlebars.registerHelper(
      "sortAttributeButton",
      AnarchyBaseActor.sortAttributeButton,
    );
