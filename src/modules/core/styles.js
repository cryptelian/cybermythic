...
export class Styles {
  ...
  selectCssClass() {
    ...
    // Debug log to verify what theme is being selected
    // console.debug(`${LOG_HEAD} Selected style setting: ${style}`);
  ...
  getThemeIdFromClass(cssClass) {
    ...
    return (
      themeMap[cssClass] || cssClass.replace(/^style-/, "").replace(/-/g, "_")
    );
  }
