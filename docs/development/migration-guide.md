...
|---------------|---------------|
| `dist/` | `build/output/` |
| `dist-compendiums/` | `build/compendiums/` |
| `dist-ninja/` | `build/development/` |
...
### Build Issues
- Build outputs now go to `build/output/` instead of `dist/`
- Update any scripts that reference the old build directories
...
---
*This migration guide is maintained in `docs/development/migration-guide.md`*
