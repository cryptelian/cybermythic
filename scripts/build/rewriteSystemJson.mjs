...
async function main() {
  const configuredSystemId = process.env.FOUNDRY_SYSTEM_ID || process.env.VITE_SYSTEM_ID;
  const systemId = (configuredSystemId && configuredSystemId.trim().length > 0)
    ? configuredSystemId.trim()
    : 'anarchy';
